...
- `robots.txt` created; `sitemap.xml` with 56 URLs (10 static + 7 collections + 39 products)
  now auto-generated by `build-shop.js` on every rebuild.
